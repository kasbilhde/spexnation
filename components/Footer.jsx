        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-md">
              ...
              <li><a href="/sunglasses/prescriptions" className="hover:text-yellow-300 transition">
                Prescriptions Sunglasses
              </a></li>
              <li><a href="/sunglasses/non-prescriptions" className="hover:text-yellow-300 transition">
