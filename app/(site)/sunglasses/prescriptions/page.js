...
const breadcrumbs = [
    ...
    { label: 'Sunglasses', href: '/sunglasses/prescriptions' },
    { label: 'Prescription Sunglasses', href: '/sunglasses/prescriptions' },
]
